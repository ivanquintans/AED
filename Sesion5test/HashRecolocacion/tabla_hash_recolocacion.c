...
int FuncionHash(char *cad, unsigned int tipoFH, unsigned int K) {
    ...
    switch (tipoFH) {
        case 1:
            ...
            posicion = suma % N;
            break;
        //es lo mismo para el caaso 2 y el 3
...
////////////////////////////////////////////////////////////////////////
int _PosicionInsertar(TablaHash t, char *cad, unsigned int tipoFH, unsigned int K, unsigned int tipoR, unsigned int a,int *hayColision,int *nPasosExtraI) {
...
//////////////////////////////////////////////////////////////////////////////
void BorrarHash(TablaHash t, char *cad, unsigned int tipoFH, unsigned int K, unsigned int tipoR, unsigned int a,int *nPasosExtra) {
    int posicion = _PosicionBuscar(t, cad, tipoFH, K, tipoR, a,nPasosExtra);
